...
<html lang="en">
  ...
  <body style="background-image: url('landscape.jpg');background-size:100% auto">>
		<div class="container" style="margin-top:5%;background-color: rgba(200, 225, 233, .6);border-radius:25px;">
		

    
      <h1>Registrierung</h1>
      <h1>Sie haben bereits ein account? <a href='login.php' class="btn btn-warning"> Login  </a></h1>
      <p>
